...
public class EloquentForgottenPasswordAdaptorTest {
    ...
    @Captor //1
    ArgumentCaptor<ForgottenPasswordRequest> argumentCaptor; //2
    ...
    public void testSendCommunication() {
        ...
        verify(customerCommunicationsService, times(1)).sendCustomerCommunication(argumentCaptor.capture());
